...
## sometimes it doesn't make clusters. You kinda have to get lucky.
...
latent_pos2_2$postTrump <- uniqueSongs$PostTrump[-c(102, 105)]
latent_pos2_2$ID <- uniqueSongs$ID[-c(102, 105)]
